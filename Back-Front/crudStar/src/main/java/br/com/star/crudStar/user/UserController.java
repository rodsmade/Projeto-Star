...
public class UserController {
  ...
  public UserSummary getCurrentUser(@CurrentUser UserPrincipal currentUser) {
    return new UserSummary(currentUser.getId(), currentUser.getUsername(), currentUser.getName(), currentUser.getNascimeto());
  }
  ...
  public UserProfile getUserProfile(@RequestParam String username) {
    ...
    return new UserProfile(user.getId(), user.getUsername(), user.getName(), user.getNascimento());
  }
